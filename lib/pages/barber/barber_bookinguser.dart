...
class BarberBookingUser extends StatefulWidget {
  const BarberBookingUser({super.key});

  @override
  State<BarberBookingUser> createState() => _BarberBookingUserState();
}

class _BarberBookingUserState extends State<BarberBookingUser> {
  List bookingUser = [];
